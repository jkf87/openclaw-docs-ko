---
title: "ComfyUI"
summary: "OpenClaw에서 ComfyUI 워크플로우 이미지, 동영상, 음악 생성 설정"
read_when:
  - OpenClaw에서 로컬 ComfyUI 워크플로우를 사용하려는 경우
  - 이미지, 동영상, 음악 워크플로우로 Comfy Cloud를 사용하려는 경우
  - 번들 comfy 플러그인 구성 키가 필요한 경우
---
