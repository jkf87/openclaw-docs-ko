---
title: "FAQ"
description: "OpenClaw 설정, 구성 및 사용에 대한 자주 묻는 질문"
---
...
:::
  ...
  ::: details OpenClaw 설치 및 설정 권장 방법
...
:::
  ...
  ::: details 필요한 런타임은 무엇인가요?
Node **>= 22**가 필요합니다. `pnpm`이 권장됩니다. Bun은 게이트웨이에 **권장되지 않습니다**.
:::


  ::: details 최신 버전에서 변경된 내용은 어디서 볼 수 있나요?
...
:::
  ...
  ::: details Windows 설치 시 git을 찾을 수 없거나 openclaw가 인식되지 않음
...
:::
  ...
  ::: details 방금 설정했습니다 - 먼저 무엇을 해야 하나요?
좋은 첫 번째 프로젝트:
...
::: details 리포지토리를 더럽히지 않고 스킬을 사용자 정의하는 방법
...
:::
  ...
  ::: details 크론 작업이 실행되지 않음. 무엇을 확인해야 하나요?
...
:::
  ...
  ::: details 메모리가 계속 잊어버립니다. 어떻게 유지시키나요?
...
::: details OpenClaw에서 사용하는 모든 데이터가 로컬에 저장되나요?
...
:::
  ...
  ::: details OpenClaw는 데이터를 어디에 저장하나요?
...
:::
  ...
  ::: details OpenClaw를 완전히 제거하는 방법
전용 가이드를 참조하십시오: [제거](/install/uninstall).
:::

## 설정 기초

::: details 설정 형식은 무엇인가요? 어디에 있나요?
...
::: details 다른 도구가 이미 18789 포트를 사용하고 있습니다
