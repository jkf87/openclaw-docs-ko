---
title: "CLI 설정 참조"
description: "CLI 설정 흐름, 인증/모델 설정, 출력 및 내부 구조에 대한 완전한 참조"
---
...
::: details Anthropic API 키
`ANTHROPIC_API_KEY`가 있으면 사용하거나 키를 요청한 후 데몬 사용을 위해 저장합니다.
:::

  ::: details OpenAI Code 구독 (Codex CLI 재사용)
