...
예시:
</code></pre><p>�OC_CODE_3�</p><p><strong>언급 및 그룹 DM</strong></p><p>길드 메시지는 기본적으로 언급 게이팅됩니다.</p><pre><code>언급 감지 포함:
...
</code></pre><h3 id="역할-기반-에이전트-라우팅" tabindex="-1">역할 기반 에이전트 라우팅 <a class="header-anchor" href="#역할-기반-에이전트-라우팅" aria-label="Permalink to &quot;역할 기반 에이전트 라우팅&quot;">​</a></h3><p><code>bindings[].match.roles</code>를 사용하여 역할 ID별로 Discord 길드 멤버를 다른 에이전트로 라우팅합니다. �OC_CODE_4�</p><h2 id="개발자-포털-설정" tabindex="-1">개발자 포털 설정 <a class="header-anchor" href="#개발자-포털-설정" aria-label="Permalink to &quot;개발자 포털 설정&quot;">​</a></h2><details class="details custom-block"><summary>앱 및 봇 생성</summary><ol><li>Discord 개발자 포털 → <strong>애플리케이션</strong> → <strong>새 애플리케이션</strong> 2. <strong>봇</strong> → <strong>봇 추가</strong> 3. 봇 토큰 복사</li></ol></details><details class="details custom-block"><summary>특권 인텐트</summary><p><strong>봇 → 특권 게이트웨이 인텐트</strong>에서 다음을 활성화합니다:</p><pre><code>- 메시지 콘텐츠 인텐트
- 서버 멤버 인텐트 (권장)
...
예시:
</code></pre><p>�OC_CODE_5�</p></details><details class="details custom-block"><summary>히스토리, 컨텍스트 및 스레드 동작</summary><p>길드 히스토리 컨텍스트:</p><pre><code>- \`channels.discord.historyLimit\` 기본값 \`20\`
- \`0\` 비활성화
