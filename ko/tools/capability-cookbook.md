---
summary: "OpenClaw 플러그인 시스템에 새로운 공유 기능을 추가하기 위한 기여자 가이드"
read_when:
  - 새로운 핵심 기능과 플러그인 등록 표면을 추가하는 경우
  - 코드가 코어, 벤더 플러그인, 또는 기능 플러그인 중 어디에 속하는지 결정하는 경우
  - 채널이나 도구를 위한 새로운 런타임 헬퍼를 연결하는 경우
title: "기능 추가 (기여자 가이드)"
sidebarTitle: "기능 추가"
---
