...
read_when:
  - `openclaw.ai/install.sh`를 이해하려는 경우
...
<Steps>
  ...
  <Step title="로드된 게이트웨이 서비스 새로 고침">
...
<AccordionGroup>
  ...
  <Accordion title="Windows: 상세 설치 프로그램 출력 가져오기">
