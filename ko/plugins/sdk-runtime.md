...
title: "플러그인 런타임 헬퍼"
sidebarTitle: "런타임 헬퍼"
summary: "api.runtime -- 플러그인에서 사용 가능한 주입된 런타임 헬퍼"
read_when:
  - 플러그인에서 코어 헬퍼(TTS, STT, 이미지 생성, 웹 검색, 서브에이전트)를 호출해야 할 때
  - api.runtime이 노출하는 항목을 이해하고 싶을 때
  - 플러그인 코드에서 구성, 에이전트, 또는 미디어 헬퍼에 접근할 때
---
