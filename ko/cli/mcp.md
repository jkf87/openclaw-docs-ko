---
summary: "OpenClaw 채널 대화를 MCP로 노출하고 저장된 MCP 서버 정의를 관리합니다"
read_when:
  - Codex, Claude Code, 또는 다른 MCP 클라이언트를 OpenClaw 백업 채널에 연결하는 경우
  - `openclaw mcp serve`를 실행하는 경우
  - OpenClaw 저장 MCP 서버 정의를 관리하는 경우
title: "mcp"
---
