---
title: "채널 플러그인 빌드하기"
sidebarTitle: "채널 플러그인"
summary: "OpenClaw용 메시징 채널 플러그인을 빌드하는 단계별 가이드"
read_when:
  - 새로운 메시징 채널 플러그인을 빌드할 때
...
<Steps>
  ...
  <Step title="채널 플러그인 객체 빌드하기">
    ...
    <Accordion title="createChatChannelPlugin이 하는 일">
...
<CardGroup cols={2}>
  ...
  <Card title="메시지 도구 통합" icon="puzzle" href="/plugins/architecture#channel-plugins-and-the-shared-message-tool">
    describeMessageTool 및 액션 검색
  </Card>
  <Card title="대상 해결" icon="crosshair" href="/plugins/architecture#channel-target-resolution">
